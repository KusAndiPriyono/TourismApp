...
//    }
    ...
    override fun getAllTourism(): Flow<com.bangkit.tourismapp.core.data.Resource<List<Tourism>>> =
        object : com.bangkit.tourismapp.core.data.NetworkBoundResource<List<Tourism>, List<TourismResponse>>() {
